export const environment = {
  ...
  //TOKENS DE ACCESO
  tokens : {
    oauth: 'https://apigateway2.tec.mx/tec-de-monterrey/api/nat/oauth2/token',
    jwt: 'https://apigateway2.tec.mx/tec-de-monterrey/api/ti/seguridad/jwt/token',
  ...
  //SERVICIOS
  apoyosEconomicos: 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos/{MATRICULA}/apoyos-economicos?ejercicio-academico={EJERCICIOACADEMICO}',
  planesDePagos : 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos/{MATRICULA}/planes-pagos?ejercicio-academico={EJERCICIOACADEMICO}',
  atributos : 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos/{MATRICULA}/atributos?ejercicio-academico={EJERCICIOACADEMICO}',
  cobros : 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos/{MATRICULA}/cobros-servicios?ejercicio-academico={EJERCICIOACADEMICO}',
  seleccionaPlan : 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos/{MATRICULA}/relationships/plan-pagos-seleccionado?ejercicio-academico={EJERCICIOACADEMICO}',
  seleccionaCobro : 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos/{MATRICULA}/cobros-servicios/{IDCOBROSERVICIO}?ejercicio-academico={EJERCICIOACADEMICO}',
  turnoInscripcion : 'https://apigateway2.tec.mx/tec-de-monterrey/api/tec/alumnos//{MATRICULA}/turnos?claveEjercicioAcademico={EJERCICIOACADEMICO}',
